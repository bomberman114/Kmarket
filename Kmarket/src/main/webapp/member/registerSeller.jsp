                ...
                <form action="/Kmarket/member/registerSeller.do" method="POST">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btnCommon btnIdCheck">중복확인</button>
                    ...
                    <section>
                        <table>
                            ...
                            <tr>
                                <th><span class="essential">*</span>통신판매업신고번호</th>
                                <td>
                                    <input type="text" name="kms_online_reg" placeholder="통신판매업신고번호 입력" required>
                                    <span class="msgOnline">- 표시 포함 입력, 예) 강남-12345, 제 1-01-23-4567호, 2017-경기성남-0011</span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="msgTel">- 표시 포함, 지역번호 포함 입력, 예) 02-234-1234</span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="msgFax">- 표시 포함, 지역번호 포함 입력, 예) 02-234-1234</span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btnCommon btnEmailAuth">인증번호 받기</button>
                                    <span class="msgEmail"></span>
                                    <div class="auth" style="margin-top:6px">
	                                    <input type="text" name="auth" placeholder="인증번호 입력"/>
	                                    <button type="button" class="btnCommon btnEmailConfirm">확인</button>
                                	</div>
                                </td>
                            </tr>
                            <tr class="addr">
                                ...
                                <td>
                                    <div>
                                        <input type="text" name="kms_zip" id="zip" placeholder="우편번호 입력 클릭" readonly>
                                       	<button type="button" class="btnCommon zip" onclick="zipcode()">우편번호 찾기</button>
                                    </div>
                                    <div>
